...
if __name__ == '__main__':
	...
	mininet@mininet-VirtualBox:~/Desktop/Project1$ more datacenter.py
#!/usr/bin/python
# CS6250 Computer Networks Project 1
# Creates a datacenter topology based on command line parameters and starts the Mininet Command Line Interf
ace.
